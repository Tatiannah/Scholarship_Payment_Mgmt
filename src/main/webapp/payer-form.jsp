...
<div class="container col-md-5">
    <div class="card">
        <div class="card-body">
           ...
           <h2>Ajouter Payement </h2>
       <form action="<%=request.getContextPath()%>/payer?action1=insert" method="post">
            ...
            <fieldset class="form-group">
                <label>Date :</label>
                <input type="date" class="form-control" name="datedate" required="required">
            </fieldset>
            
            <fieldset class="form-group">
                <label>Nombre du mois :</label>
                <input type="number" class="form-control" name="nbr_mois" required="required">
            </fieldset>
